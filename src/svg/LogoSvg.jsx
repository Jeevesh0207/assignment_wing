...
const LogoSvg = (props) => (
  <>
    <svg
      ...
      {...props}
    >
      <g filter="url(#filter0_i_483_341)">
        ...
        <rect
          ...
          height={33.2}
          rx={5.2}
          fill="url(#paint0_linear_483_341)"
        />
        <rect
          x={0.399994}
          width={33.2}
          height={33.2}
          rx={5.2}
          fill="url(#paint1_linear_483_341)"
        />
        <rect
          x={0.599994}
          y={0.2}
          ...
          height={32.8}
          rx={5}
          stroke="url(#paint2_linear_483_341)"
          strokeWidth={0.4}
        />
        <path
      ...
      <defs>
        ...
        >
          ...
          <feBlend
            mode="normal"
            in2="shape"
            result="effect1_innerShadow_483_341"
          />
        </filter>
        <linearGradient
          id="paint0_linear_483_341"
          x1={32.6}
          y1={0.600002}
          x2={1.6}
          y2={34.2}
